...
var MONGOSTORE = module.exports = function MongoStore(options, callback) {
  ...
  var db
    , server_config
    , server_types = [mongo.Server, mongo.ReplSetServers]
    , has_server_config = options.server_config && server_types.some(function (i) {
        return options.server_config instanceof i;
      });
  ...
  if (options.db instanceof mongo.Db) {
