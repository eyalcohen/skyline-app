...
(function () {
    ...
    function onFetchOnly(node) {
        ...
        for (i = 0; (resourceName = scriptWaiting[i]); i++) {
            ...
            if (loadedNode &&
                ...
                requirejs.addScriptToDom(loadedNode);
            } else {
                break;
            }
        }
    ...
    define({
        ...
        load: function (name, req, onLoad, config) {
            ...
            //this script.
            requirejs.s.skipAsync[url] = true;
            if (supportsInOrderExecution || config.isBuild) {
                ...
                context = requirejs.s.contexts._;
                ...
                if (!context.urlFetched[url] && !context.loaded[name]) {
                    ...
                    requirejs.resourcesReady(false);
                    context.scriptCount += 1;

                    //Fetch the script now, remember it.
                    node = requirejs.attach(url, context, name, null, null, onFetchOnly);
                ...
                if (req.specified(name)) {
                    ...
                    requirejs.attach(url, null, name, scriptCacheCallback, "script/cache");
                }
            }
        }
    });
