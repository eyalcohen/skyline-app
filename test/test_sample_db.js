#!/usr/bin/env node_modules/.bin/nodeunit
...
exports.testBuildChannelTree = function(test) {
  var schema = [
    ...
    { channelName: 'bms1/cells[0].voltage',
      humanName: [ 'Battery Module 1', 'Cell data', 'Cell 0', 'Cell voltage' ],
      type: 'float' },
    { channelName: 'bms1/cells[1].voltage',
      humanName: [ 'Battery Module 1', 'Cell data', 'Cell 1', 'Cell voltage' ],
      type: 'float' },
  ];
  var samples = schema.map(function(s) { return { beg: 5, end: 9, val: s }; });
  var expected = [
    { shortName: 'gps/', type: 'category',
      sub: [
        { shortName: 'latitude_deg',
          ...
          units: '°',
          type: 'float' },
        { shortName: 'satellites.', type: 'category',
          sub: [
            { shortName: 'count',
    ...
    { shortName: 'bms1/', type: 'category',
      ...
      sub: [
        { shortName: 'cells', type: 'category',
          humanName: 'Cell data',
          sub: [
            { shortName: '[0].', type: 'category',
              humanName: 'Cell 0',
              sub: [
                { shortName: 'voltage',
                  channelName: 'bms1/cells[0].voltage',
                  humanName: 'Cell voltage',
                  type: 'float' } ] },
            { shortName: '[1].', type: 'category',
              humanName: 'Cell 1',
              sub: [
                { shortName: 'voltage',
                  channelName: 'bms1/cells[1].voltage',
