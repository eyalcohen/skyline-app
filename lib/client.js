    ...
    function (err) {
      ...
      Step(
        ...
        function (err) {
          ...
          var _this = _.after(_.size(schema) * 2, this);
          _.each(schema, function (s) {
            ...
            db.Channels.create(s, function (err, channel) {
              ...
              // Index for search.
              com.index(self.redis, 'channels', channel, ['humanName'], _this);
              com.index(self.redis, 'channels', channel,
