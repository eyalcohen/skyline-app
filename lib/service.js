...
exports.routes = function (app) {
   ...
   */
  function handler(sfn, options, req, res) {
    ...
    res.render('index', _.defaults(options, {
      user: req.user,
  ...
  // Dataset profile
  app.get('/service/dataset.profile/:un/:id', function (req, res) {
  ...
  // Dataset
  app.get('/:un/datasets/:id', _.bind(handler, undefined, function (req, res) {
    res.render('static', {root: app.get('ROOT_URI')});
  }, {wide: true}));
