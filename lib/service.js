...
exports.routes = function (app) {
  ...
  app.get('/service/chart.profile', function (req, res) {
    ...
    if ((!state.datasets || _.isEmpty(state.datasets)) && !state.key)
      return res.redirect('/service/static.profile');
      ...
      function (err, datasets, notes) {
        ...
        Step(
          function () {
            ...
            // Get comments on the state datasets.
            db.fill(datasets, 'Comments', 'parent_id', {sort: {created: -1},
                limit: 5, reverse: true, inflate: {author: profiles.member}},
                this.parallel());
          },
          function (err) {
