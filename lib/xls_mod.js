...
function s2a(s) {
	if(false && typeof Buffer !== 'undefined') return new Buffer(s, "binary");
	var w = s.split("").map(function(x){return x.charCodeAt(0);});
	return w;
}

if(false && typeof Buffer !== "undefined") {
...
function bconcat(bufs) { return (false && typeof Buffer !== 'undefined') ? Buffer.concat(bufs) : [].concat.apply([], bufs); }
	...
	for(i = 0; i != NumProps; ++i) {
		...
		if(PIDSI) {
			...
			if(piddsi.n == "CodePage") switch(PropH[piddsi.n]) {
				...
				case 1200: // UTF16LE
				case 1201: // UTF16BE
				// TODO: case 65000: case -536: // UTF-7
				case 65001: case -535: break; //TODO: Not really // UTF-8
				/* falls through */
...
if(false && typeof require !== 'undefined' && typeof exports !== 'undefined') {
	Buffers = Array;
	...
	if(false && typeof module !== 'undefined' && require.main === module)
	...
	while(blob.l < blob.length) {
		...
		if(R && R.f) {
			...
			switch(R.n) {
				...
				case 'UsesELFs': break; //TODO: if(val) console.error("Unsupported ELFs"); break;
				case 'MTRSettings': {
