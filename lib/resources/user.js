  ...
  db.Users.create(props, function (err, user) {
    if (err && err.code === 11000) {
      if (err.err.indexOf('username') !== -1)
        ...
        return cb('Email address exists');
      else
        return cb('Unknown duplicate');
    }
