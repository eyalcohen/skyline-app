    ...
    db[typeResource].read({_id: resource_id},
      ...
      Step(
        function () {
          ...
          if (type === 'comment')
            // TODO: handle all pparent types.
            db.Views.read({_id: parent.parent_id},
          ...
          db.Comments.create(props, {inflate: {author: profiles.user}},
            ...
            switch (type) {
              ...
              case 'view':
                ...
                break;
              case 'comment':
                target.n = pparent.name;
                target.s = [pparent.author.username, 'views', pparent.slug].join('/');
            }
            ...
            // Publish comment.
            pubsub.publish('comments', 'comment.new', com.client(doc));
