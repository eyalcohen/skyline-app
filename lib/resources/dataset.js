...
exports.routes = function (app) {
  ...
  // Create
  // (Currently handled by lib/client.js)
  ...
  app.get('/api/datasets/:id', function (req, res, next) {
    ...
    res.contentType('.csv');
    var csv = CSV().to.stream(res, { lineBreaks: 'windows', end: false });
    var schema = {};
    var sampleSet = {};
    var samplesSplit;
    ...
    Step(
      function fetchData() {
        ...
        channels.forEach(function (channelName) {
          ...
          samples.fetchSamples(id, channelName, fetchOptions,
        ...
        { var next = parallel();
          ...
          samples.fetchSamples(id, '_schema', fetchOptions,
                                errWrap(next, function (samples_) {
            samples_.forEach(function (sample) {
