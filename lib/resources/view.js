...
exports.routes = function (app) {
      ...
      function (err, parent) {
        ...
        if (props.staticImg) {
          var obj = {
            ...
            key: 'views-' + props.slug,
            data: new Buffer(props.staticImg.split(',')[1], 'base64'),
            contentType: 'image/png',
            access: props.public ? 'public-read' : 'private',
          }
    ...
    db.Views.read(query, function (err, doc) {
      ...
      if (req.body.staticImg) {
        var obj = {
          ...
          contentType: 'image/png',
          access: doc.public ? 'public-read' : 'private',
        }
        app.get('storage').store(obj);
  ...
  app.delete('/api/views/:id', function (req, res) {
    ...
    db.Views.read(query, function (err, doc) {
      ...
      // this failing
      app.get('storage').delete('snapshots-skyline', 'views-' + doc.slug);
